        ...
        try
        {
            ...
            if (index != -1)
            {
                ...
                if (BasicAmt > 0)
                {
                    ...
                    txtBasicAmount.Text = string.Format("{0:0.00}", BasicAmt);
    ...
    public string VerifyCalucalte()
    {
        try
        {
                ...
                for (int i = 0; i < dgBillPassing.Rows.Count; i++)
                {
                    ...
                    if (chkRow.Checked)
                    {
                        //basicAmtAfterCal = basicAmtAfterCal+float.Parse(((Label)(dgBillPassing.Rows[i].FindControl("lblSPOD_TOTAL_AMT"))).Text);
        ...
        return string.Format("{0:0.00}", basicAmtAfterCal);
    }
    #endregion
