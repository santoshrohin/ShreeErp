<%@ Page Title="Issue Fill Off Sheet" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="IssueFillOffSheet.aspx.cs" Inherits="Transactions_ADD_IssueFillOffSheet" %>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlCustomer" CssClass="select2_category form-control" runat="server"
                                                                TabIndex="6" MsgObrigatorio="Customer Name" 
                                                                Visible="True">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <asp:TextBox CssClass="form-control " ID="txtSpecInstruction" placeholder="Special Instruction"
                                                    TabIndex="8" runat="server" TextMode="SingleLine" Rows="1" MsgObrigatorio="Special Instruction" ReadOnly="true"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                    <ContentTemplate>
                                                        <asp:TextBox  CssClass="form-control text-right input-sm" ID="txtBarrels"
                                                            placeholder="0.000" TabIndex="10" runat="server" MsgObrigatorio="Barrels" 
                                                           ></asp:TextBox>
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                                    <ContentTemplate>
                                                        <asp:TextBox  CssClass="form-control text-right input-sm" ID="txtQty"
                                                            placeholder="0.000" TabIndex="11" runat="server" MsgObrigatorio="Quantity" 
                                                            ></asp:TextBox>
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                    <ContentTemplate>
                                                         <asp:DropDownList ID="ddlUnit" CssClass="select2_category form-control input-sm"
                                                            runat="server" MsgObrigatorio="Type" TabIndex="12"></asp:DropDownList>  
                                                    </ContentTemplate>                                                  
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Qty" SortExpression="FOSD_WGT" HeaderStyle-HorizontalAlign="Right">
                                                             ...
                                                             <asp:TemplateField HeaderText="Issue Qty" SortExpression="StockQty" HeaderStyle-HorizontalAlign="Right"
                                                                ...
                                                                <ItemTemplate>
                                                                    <%--<asp:Label ID="lblIssueQty" CssClass=" Control-label pull-right" runat="server" Text='<%# Bind("IssueQty") %>'></asp:Label>--%>
                                                                    
                                                                     <asp:TextBox ID="txtIssueQty" runat="server"  CssClass="form-control text-right"
                                                                        placeholder="0.00" MsgObrigatorio="Qty"  Text='<%# Eval("FOSD_ISSUE_QTY") %>' AutoPostBack="true" OnTextChanged="txtIssueQty1_TextChanged" MaxLength="50" TabIndex="14" ></asp:TextBox>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtFillby" placeholder="Filled By"
                                                    TabIndex="15" runat="server" MaxLength="100" MsgObrigatorio="Filled By" ReadOnly="true"></asp:TextBox>
                                            </div>
                                            <label class="col-md-2 control-label text-right ">
                                                 Fill Date
                                            </label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <asp:TextBox CssClass="form-control " ID="txtNotes" placeholder="Notes" 
                                                    TabIndex="18" runat="server" Rows="1" MsgObrigatorio="Notes" ReadOnly="true"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
