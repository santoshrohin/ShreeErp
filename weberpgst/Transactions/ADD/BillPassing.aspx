                                                    ...
                                                    <div class="col-md-3">
                                                      ...
                                                      <div class="col-md-2">
                                                        <asp:CheckBox runat="server" AutoPostBack="true" OnCheckedChanged="chkUseCustRej_CheckedChanged"
                                                            ID="chkUseCustRej" Visible="true"  Text="Use Cust Rej" CssClass="checker" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <asp:UpdatePanel ID="UpdatePanel21" runat="server">
                                                            <ContentTemplate>
                                                                <asp:RadioButtonList Visible="false" OnSelectedIndexChanged="rbLstIsExise_SelectedIndexChanged"
                                                                    RepeatDirection="Horizontal" runat="server" CssClass="radio-list" AutoPostBack="true"
                                                                    ID="rbLstIsExise">
                                                    ...
                                                    <div class="col-md-2">
                                                        <asp:CheckBox runat="server" Visible="false" AutoPostBack="true" OnCheckedChanged="ChkUseService_CheckedChanged"
                                                    ...
                                                    <ContentTemplate>
                                                        <asp:GridView ID="dgBillPassing" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField   HeaderText="IWM TYPE" SortExpression="IWM_TYPE"
                                                                ...
                                                                <asp:TemplateField HeaderText="Disc.Amt" SortExpression="SPOD_DISC_AMT" Visible="false" HeaderStyle-HorizontalAlign="Right">
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="EX_FREIGHT" SortExpression="SPOD_EXC_Y_N" HeaderStyle-HorizontalAlign="Left"
                                                                    Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblEX_FREIGHT" runat="server" Text='<%# Eval("EX_FREIGHT") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <HeaderStyle HorizontalAlign="Left" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="EX_PACKING_AMT" SortExpression="SPOD_EXC_Y_N" HeaderStyle-HorizontalAlign="Left"
                                                                    Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblEX_PACKING_AMT" runat="server" Text='<%# Eval("EX_PACKING_AMT") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <HeaderStyle HorizontalAlign="Left" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="EX_OTHER_AMT" SortExpression="SPOD_EXC_Y_N" HeaderStyle-HorizontalAlign="Left"
                                                                    Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblEX_OTHER_AMT" runat="server" Text='<%# Eval("EX_OTHER_AMT") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <HeaderStyle HorizontalAlign="Left" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="EX_INSURANCE_AMT" SortExpression="SPOD_EXC_Y_N" HeaderStyle-HorizontalAlign="Left"
                                                                    Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblEX_INSURANCE_AMT" runat="server" Text='<%# Eval("EX_INSURANCE_AMT") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <HeaderStyle HorizontalAlign="Left" />
                                                                </asp:TemplateField>
                                                            </Columns>
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel1456" runat="server">
                                                            <ContentTemplate>
                                                                <asp:TextBox CssClass="form-control text-right" ID="txtDiscountAmt" Text="0.00" TabIndex="8"
                                                                    AutoPostBack="true" OnTextChanged="txtDiscountAmt_TextChanged" runat="server"></asp:TextBox>
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                                            <ContentTemplate>
                                                                <asp:TextBox CssClass="form-control text-right" ID="txtPackingAmt" Text="0.00" TabIndex="9"
                                                                    runat="server" AutoPostBack="true" OnTextChanged="txtPackingAmt_TextChanged"></asp:TextBox>
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                            <ContentTemplate>
                                                                <asp:TextBox CssClass="form-control text-right" ID="txtFreightAmt1" Text="0.00" TabIndex="19"
                                                                    runat="server" AutoPostBack="true" OnTextChanged="txtFreightAmt1_TextChanged"></asp:TextBox>
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel17" runat="server">
                                                            <ContentTemplate>
                                                                <asp:TextBox CssClass="form-control text-right" ID="txtInsuranceAmt" Text="0.00"
                                                                    TabIndex="20" runat="server" AutoPostBack="true" OnTextChanged="txtInsuranceAmt_TextChanged"></asp:TextBox>
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel18" runat="server">
                                                            <ContentTemplate>
                                                                <asp:TextBox CssClass="form-control text-right" ID="txtTransportAmt" Text="0.00"
                                                                    TabIndex="21" runat="server" AutoPostBack="true" OnTextChanged="txtTransportAmt_TextChanged"></asp:TextBox>
