<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="CreditNote.aspx.cs"
    Inherits="Transactions_ADD_CreditNote" Title="Credit Note" EnableEventValidation="true" %>
                                ...
                                <div class="form-body">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class=" col-md-2 control-label text-right ">
                                                    <font color="red">*</font> Customer Name :</label><div class="col-md-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class=" col-md-2 control-label text-right ">
                                                    <font color="red">*</font> Date of Credit Note :</label><div class="col-md-3 ">
                                                        <div class="input-group">
                                                            <asp:TextBox ID="txtCreditDate" runat="server" CssClass="form-control" placeholder="dd MMM yyyy"
                                                                ValidationGroup="Save" TabIndex="2" MsgObrigatorio="Credit Date"></asp:TextBox>
                                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                            <cc1:CalendarExtender ID="txtCreditDate_CalendarExtender" runat="server" Enabled="True"
                                                                Format="dd MMM yyyy" TargetControlID="txtCreditDate" PopupButtonID="txtCreditDate">
                                                            </cc1:CalendarExtender>
                                                        </div>
                                                    </div>
                                                <label class="col-md-2 control-label text-right ">
                                                    <font color="red">*</font>Credit Note Serial No.:
                                                </label>
                                                <div class="col-md-3">
                                                    <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox ID="txtCreditSerialNumber" runat="server" placeholder="Credit Note Serial No"
                                                                CssClass="form-control" ValidationGroup="Save" Enabled="false" MsgObrigatorio="Credit Note Serial No"
                                                                MaxLength="20"></asp:TextBox>
                                                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender8" TargetControlID="txtCreditSerialNumber"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class=" col-md-2 control-label text-right ">
                                                    GSTIN No. :</label><div class="col-md-3 ">
                                                        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                            <ContentTemplate>
                                                                <asp:TextBox ID="txtGSTINNo" runat="server" placeholder="GSTIN No" CssClass="form-control"
                                                                    ValidationGroup="Save" MaxLength="30" Enabled="false"></asp:TextBox>
                                                ...
                                                <label class=" col-md-2 control-label text-right ">
                                                    E-Way Bill No. :</label><div class="col-md-3 ">
                                                        <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                            <ContentTemplate>
                                                                <asp:TextBox ID="txtEWayBillNo" runat="server" placeholder="E-Way Bill No" CssClass="form-control"
                                                                    ValidationGroup="Save" TabIndex="4" MaxLength="20" onkeypress="return validateFloatKeyPress(this,event);"></asp:TextBox>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel50" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox ID="txtAddress" runat="server" CssClass="form-control" placeholder="Address"
                                                                ValidationGroup="Save" TabIndex="5" TextMode="MultiLine" ReadOnly="false"></asp:TextBox>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class=" col-md-2 control-label text-right ">
                                                    State :</label><div class="col-md-3 ">
                                                ...
                                                <label class=" col-md-2 control-label text-right ">
                                                    State Code :</label><div class="col-md-3 ">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel30" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass=" form-control text-right" ID="txtAmortAmt" Text="" TabIndex="18"
                                                                runat="server" placeholder="Rate" AutoPostBack="True" ReadOnly="true" onkeypress="return validateFloatKeyPress(this,event);"></asp:TextBox>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel25" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox AutoPostBack="true" CssClass="form-control text-right" ID="txtQtyPack"
                                                                Text="" TabIndex="19" MsgObrigatorio="Qty/Pack" placeholder="Qty/Pack" runat="server"
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel29" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox AutoPostBack="true" CssClass="form-control text-right" ID="txtPacking"
                                                                Text="" TabIndex="20" MsgObrigatorio="Packing" placeholder="Packing" runat="server"
                                                                onkeypress="return validateFloatKeyPress(this,event);"></asp:TextBox>
                                                                    ...
                                                                    <asp:GridView ID="dgMainDC" runat="server" CssClass="table table-striped table-bordered table-advance table-hover"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Item Code" SortExpression="ItemCode" Visible="True">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblCND_I_CODENO" runat="server" Text='<%# Bind("CND_I_CODENO") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel36" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" AutoPostBack="true" ID="txtInsuranceAmt"
                                                                ...
                                                                onkeypress="return validateFloatKeyPress(this,event);" runat="server"></asp:TextBox>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel37" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtOtherAmt" Text=""
                                                                ...
                                                                onkeypress="return validateFloatKeyPress(this,event);" TabIndex="37" runat="server"></asp:TextBox>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel41" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox Visible="true" CssClass="form-control text-right input-sm" ID="txtTOS"
                                                                placeholder="0.00" TabIndex="42" runat="server" AutoPostBack="true" Text=""></asp:TextBox>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                                <div class="col-md-3">
