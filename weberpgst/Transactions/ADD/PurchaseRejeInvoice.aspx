                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-1">
                                                    <asp:UpdatePanel ID="UpdatePanel41" runat="server">
                                                        <ContentTemplate>
                                                            <label class="checkbox"><asp:CheckBox ID="chkIsSuppliement" runat="server" CssClass="checker" TabIndex="4"
                                                                    Checked="false" />
                                                            </label>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <%-- <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label label-sm">
                                                        <span class="required"></span>Purchase No
                                                    </label>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlPONo" CssClass="select2_category form-control input-sm"
                                                                runat="server" TabIndex="7" AutoPostBack="True" MsgObrigatorio="PO Number" OnSelectedIndexChanged="ddlPONo_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="ddlItemName" EventName="SelectedIndexChanged" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel ID="UpdatePanel22" runat="server" UpdateMode="Conditional">
                                                        ...
                                                        <Triggers>
                                                            <%--<asp:AsyncPostBackTrigger ControlID="txtBasicExcAmt" EventName="Click" />--%>
                                                            <asp:AsyncPostBackTrigger ControlID="txtBasicExcPer" EventName="TextChanged" />
                                                            <asp:AsyncPostBackTrigger ControlID="btnInsert" EventName="Click" />
                                                ...
                                                <div class="col-md-4">
                                                    <asp:UpdatePanel ID="UpdatePanel19" runat="server" UpdateMode="Conditional">
                                                        ...
                                                        <Triggers>
                                                            ...
                                                            <%--<asp:AsyncPostBackTrigger ControlID="txtFreight" EventName="TextChanged" />--%>
                                                            <asp:AsyncPostBackTrigger ControlID="txtPackAmt" EventName="TextChanged" />
                                                            <%--<asp:AsyncPostBackTrigger ContrFreightolID="txtOtherAmount" EventName="TextChanged" />--%>
                                                            <asp:AsyncPostBackTrigger ControlID="ddlTaxName" EventName="SelectedIndexChanged" />
                                                            <asp:AsyncPostBackTrigger ControlID="btnInsert" EventName="Click" />
                                                            <asp:AsyncPostBackTrigger ControlID="dgInvoiceAddDetail" EventName="RowCommand" />
