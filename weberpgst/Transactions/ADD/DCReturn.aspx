                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanele7" runat="server">
                                                            <ContentTemplate>
                                                                <div class="input-group">
                                                                    <asp:DropDownList ID="ddlType" Enabled="false" CssClass="select2" Width="250px" runat="server"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                        <ContentTemplate>
                                                            <div class="input-group">
                                                                <asp:DropDownList ID="ddlchallanNo" CssClass="select2" Width="100%" runat="server"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="input-group">
                                                        ...
                                                        <asp:TextBox ID="txtPartyChNo" runat="server" placeholder="Party Challan Number"
