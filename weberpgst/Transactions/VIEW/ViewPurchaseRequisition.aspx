                    ...
                    <div class="portlet box green">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                ...
                                <a href="../../Masters/ADD/PurchaseDefault.aspx" class="remove"></a>
                            </div>
                        </div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="dgPurchaseRequsition" runat="server" AutoGenerateColumns="False"
                                        ...
                                        AllowPaging="True"  PageSize="15" OnRowDeleting="dgPurchaseRequsition_RowDeleting" OnRowCommand="dgPurchaseRequsition_RowCommand" OnPageIndexChanging="dgPurchaseRequsition_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Per. Requisition No" SortExpression="MR_BATCH_NO" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
