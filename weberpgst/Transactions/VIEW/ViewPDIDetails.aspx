<%@ Page Title="PDI Details" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ViewPDIDetails.aspx.cs" Inherits="Transactions_VIEW_ViewPDIDetails" %>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="dgInvoiceDettail" TabIndex="3" runat="server" AutoGenerateColumns="False" Width="100%"
                                        CellPadding="4" Font-Size="12px" Font-Names="Verdana" GridLines="Both" DataKeyNames="INSPDI_INSM_CODE"
                                        ...
                                        <Columns>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <li>
                                                                    <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                        Text="View" CommandArgument='<%# Bind("INSPDI_INSM_CODE") %>'><i class="fa fa-search"></i>View</asp:LinkButton>
                                                                </li>
                                                                <li>
                                                                    <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                        Text="Modify" CommandArgument='<%# Bind("INSPDI_INSM_CODE") %>'><i class="fa fa-edit"></i> Modify</asp:LinkButton>
                                                                </li>
                                                                <li>
                                                                    <asp:LinkButton ID="lnkPrint" runat="server" CausesValidation="False" CommandName="Print"
                                                                        Text="Print" CommandArgument='<%# Bind("INSPDI_INSM_CODE") %>'><i class="fa fa-print"></i> Print</asp:LinkButton></li>
                                                                <li>
                                                                    <li>
                                            ...
                                            <asp:TemplateField HeaderText="INM_CODE" SortExpression="INM_CODE" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblINSPDI_CODE" CssClass="formlabel" runat="server" Text='<%# Bind("INSPDI_INSM_CODE")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Party Name" SortExpression="I_CODENO" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblI_CODENO" CssClass=" Control-label" runat="server" Text='<%# Eval("P_NAME") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                        </Columns>
