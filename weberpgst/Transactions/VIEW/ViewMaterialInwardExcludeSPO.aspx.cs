...
public partial class Transactions_VIEW_ViewMaterialInwardExcludeSPO : System.Web.UI.Page
{
    #region Variable
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            CommonClasses.SendError("With Out PO Material Inward ", "Page_Load", Ex.Message);
        }
    }
    #endregion
    ...
    private void LoadInward()
    {
        ...
        {
            CommonClasses.SendError("With Out PO Material Inward ", "LoadInward", Ex.Message);
        }
    }
    #endregion
    ...
    protected void txtString_TextChanged(object sender, EventArgs e)
    {
        ...
        {
            CommonClasses.SendError("With Out PO Material Inward ", "txtString_TextChanged", Ex.Message);
        }
    }
    #endregion
    ...
    private void LoadStatus(TextBox txtString)
    {
        ...
        {
            CommonClasses.SendError("With Out PO Material Inward ", "LoadStatus", ex.Message);
        }
    }
    #endregion
    ...
    protected void btnAddNew_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string type = "INSERT";
                Response.Redirect("~/Transactions/ADD/MaterialInwardExcludeSPO.aspx?c_name=" + type, false);
            }
            else
            {
        ...
        {
            CommonClasses.SendError("With Out PO Material Inward ", "btnAddNew_Click", Ex.Message);
        }
    }
    #endregion
    ...
    protected void dgDetailPO_RowEditing(object sender, GridViewEditEventArgs e)
    {
        try
        {
            if (CommonClasses.ValidRights(int.Parse(right.Substring(2, 1)), this, "For Modify"))
            {
                ...
                {
                    Response.Redirect("~/Transactions/ADD/MaterialInwardExcludeSPO.aspx?c_name=" + type + "&cpom_code=" + cpom_code, false);
                }
            }
            else
            {
        ...
        {
            CommonClasses.SendError("With Out PO Material Inward ", "dgPODetail_RowEditing", Ex.Message);
        }
    }
    #endregion
    ...
    protected void dgDetailPO_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            CommonClasses.SendError("With Out PO Material Inward -View", "GridView1_RowCommand", Ex.Message);
        }
    }
    #endregion
    ...
    public bool ShowMessage(string DiveName, string Message, string MessageType)
    {
        ...
        {
            CommonClasses.SendError("With Out PO With Out PO Material Inward  -View", "ShowMessage", Ex.Message);
            return false;
        }
    }
    #endregion
