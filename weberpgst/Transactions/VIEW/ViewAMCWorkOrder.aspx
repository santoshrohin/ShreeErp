<%@ Page Title="Work Order" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewAMCWorkOrder.aspx.cs" Inherits="Transactions_VIEW_ViewAMCWorkOrder" %>
                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="dgWODetails" runat="server" AutoGenerateColumns="False"
                                        ...
                                        AllowPaging="True" OnRowEditing="dgWODetails_RowEditing" OnRowCommand="dgWODetails_RowCommand"
                                        OnRowDeleting="dgWODetails_RowDeleting" OnPageIndexChanging="dgWODetails_PageIndexChanging"
                                        PageSize="15">
                                        <Columns>
