<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewCustomerSchedule.aspx.cs"
    Inherits="Transactions_VIEW_ViewCustomerSchedule" Title="Customer Schedule" %>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="btn-group pull-right">
                                                <asp:LinkButton ID="btnAddNew" CssClass="btn green" runat="server" OnClientClick="()"
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                        <ContentTemplate>
                                            <asp:GridView ID="dgCustomerSchedule" runat="server" AutoGenerateColumns="False"
                                                ...
                                                DataKeyNames="CS_CODE" CssClass="table table-striped table-bordered table-advance table-hover"
                                                AllowPaging="True" OnRowCommand="dgCustomerSchedule_RowCommand" OnRowDeleting="dgCustomerSchedule_RowDeleting"
                                                OnPageIndexChanging="dgCustomerSchedule_PageIndexChanging" PageSize="15">
                                                <Columns>
                                                                    ...
                                                                    <ul class="dropdown-menu" role="menu">
                                                                        <li>
                                                                            <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                                Text="View" CommandArgument='<%# Bind("CS_CODE") %>'><i class="fa fa-search"></i>View</asp:LinkButton>
                                                                        </li>
                                                                        <li>
                                                                            <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                                Text="Modify" CommandArgument='<%# Bind("CS_CODE") %>'><i class="fa fa-edit"></i> Modify</asp:LinkButton>
                                                                        </li>
                                                                        <li>
                                                                        ...
                                                                        <li>
                                                                            <asp:LinkButton ID="lnkPrint" runat="server" CausesValidation="False" CommandName="Print"
                                                                                Text="Print" CommandArgument='<%# Bind("CS_CODE") %>'><i class="fa fa-print"></i> Print</asp:LinkButton>
                                                                        </li>
                                                                        <li>
                                                                            <asp:LinkButton ID="lnkMultiple" runat="server" CausesValidation="False" CommandName="PrintMult"
                                                                                Text="Print Multiple" CommandArgument='<%# Bind("CS_CODE") %>'><i class="fa fa-print"></i> Print Multiple</asp:LinkButton>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <asp:TemplateField HeaderText="CS_CODE" SortExpression="CS_CODE" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblCS_CODE" CssClass="formlabel" runat="server" Text='<%# Bind("CS_CODE")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Schedule No." SortExpression="CS_CODE" HeaderStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblCS_NO" runat="server" Text='<%# Eval("CS_NO")%>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Customer Name" SortExpression="CS_CODE" HeaderStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblP_NAME" runat="server" Text='<%# Eval("P_NAME") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Schedule Date" SortExpression="CS_CODE" HeaderStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblCS_MONTH" CssClass=" Control-label" runat="server" Text='<%# Eval("CS_MONTH") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                    </asp:TemplateField>
                                                </Columns>
                                            ...
                                            <div class="form-horizontal">
                                                <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="col-md-6 text-right" id="lblPrintCopy" runat="server" visible="false">
                                                                    ...
                                                                    <asp:UpdatePanel runat="server" ID="UpdatePuiu">
                                                                        <ContentTemplate>
                                                                            <asp:CheckBox runat="server" ID="chkPrintCopy1" OnCheckedChanged="chk1_CheckedChanged"
                                                                                AutoPostBack="true" Text="1" CssClass="checker" Visible="false" />
                                                                        </ContentTemplate>
                                                                    </asp:UpdatePanel>
                                                                </div>
                                                                <div class="col-md-1">
                                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel4">
                                                                        <ContentTemplate>
                                                                            <asp:CheckBox runat="server" ID="chkPrintCopy2" Text="2" OnCheckedChanged="chk1_CheckedChanged"
                                                                                AutoPostBack="true" CssClass="checker" Visible="false" />
                                                                        </ContentTemplate>
                                                                    </asp:UpdatePanel>
                                                                </div>
                                                                <div class="col-md-1">
