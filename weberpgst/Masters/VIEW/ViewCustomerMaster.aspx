                        ...
                        <div class="portlet-body">
                            ...
                            <div class="row" style="overflow-x: auto;">
                                <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                    <ContentTemplate>
                                        <asp:GridView ID="dgCustomerMaster" TabIndex="3" runat="server" Width="100%" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="GST Number" SortExpression="P_LBT_NO" HeaderStyle-HorizontalAlign="Left"
                                                    Visible="true">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblP_LBT_NO" CssClass="" runat="server" Text='<%# Eval("P_LBT_NO") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </asp:TemplateField>
                                            </Columns>
