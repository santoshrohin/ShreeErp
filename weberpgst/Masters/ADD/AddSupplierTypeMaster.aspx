...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtSupplierTypeCode" placeholder="Supplier Type Code"
                                                    TabIndex="1" runat="server" MaxLength="30" MsgObrigatorio="Please Enter Supplier Type Code"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-2">
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel111" runat="server">
                                                    <ContentTemplate>
                                                        <asp:TextBox CssClass="form-control " ID="txtSupplierTypeDesc" placeholder="Supplier Type Desc"
                                                            TabIndex="1" runat="server" MaxLength="30" MsgObrigatorio="Please Enter Supplier Type Desc"
    ...
    <script type="text/javascript">
        function VerificaCamposObrigatorios() {
            try {
                if (VerificaObrigatorio('#<%=txtSupplierTypeCode.ClientID%>', '#Avisos') == false) {

                    $("#Avisos").fadeOut(6000);
                    return false;
                }
                if (VerificaObrigatorio('#<%=txtSupplierTypeDesc.ClientID%>', '#Avisos') == false) {
