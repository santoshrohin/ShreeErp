<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="AdminDefault.aspx.cs" Inherits="Masters_ADD_AdminDefault" Title="Administrator Page" %>
                    ...
                    <div class="row">
                        <div class="col-md-4 sidebar-content ">
                            <ul class="ver-inline-menu tabbable margin-bottom-25">
                                <li class="active"><a href="#" data-toggle="tab"><i class="fa fa-briefcase"></i>Admin Masters</a> <span class="after"></span></li>
                                <li><a href="../VIEW/ViewCityMaster.aspx"><i class="fa fa-tasks"></i>City Master</a> </li>
                                <li>
                                    <a href="../VIEW/ViewStateMaster.aspx"><i class="fa fa-tasks"></i>State Master</a> </li>
                            </ul>
                        </div>
                        <div class="col-md-3">
                        </div>
