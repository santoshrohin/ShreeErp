<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewVehicleMaster.aspx.cs"
    Inherits="Masters_VIEW_ViewVehicleMaster" Title="State Master" %>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="dgVehicle" runat="server" Width="100%" AutoGenerateColumns="False"
                                        CellPadding="4" ForeColor="#333333" GridLines="None" DataKeyNames="VM_CODE" Font-Names="Verdana"
                                        Font-Size="12px" ShowFooter="false" OnRowDeleting="dgVehicle_RowDeleting" OnRowEditing="dgVehicle_RowEditing"
                                        CssClass="table table-striped table-bordered table-advance table-hover" OnPageIndexChanging="dgVehicle_PageIndexChanging"
                                        OnRowCommand="dgVehicle_RowCommand" OnRowUpdating="dgVehicle_RowUpdating">
                                        <Columns>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <li>
                                                                    <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                        Text="View" CommandArgument='<%# Bind("VM_CODE") %>'><i class="fa fa-search"></i> View</asp:LinkButton>
                                                                </li>
                                                                <li>
                                                                    <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                        Text="Modify" CommandArgument='<%# Bind("VM_CODE") %>'><i class="fa fa-edit"></i> Modify</asp:LinkButton>
                                                                </li>
                                                                <li>
                                            ...
                                            <asp:TemplateField HeaderText="VM_CODE" SortExpression="VM_CODE" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblVM_CODE" runat="server" Text='<%# Bind("VM_CODE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Transport" SortExpression="VM_CODE" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblT_NAME" runat="server" Text='<%# Eval("T_NAME") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Vehicle" SortExpression="VM_CODE" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblVM_NAME" runat="server" Text='<%# Eval("VM_NAME") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                        </Columns>
