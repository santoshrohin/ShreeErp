<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="TransportMaster.aspx.cs"
    Inherits="Admin_Add_TransportMaster" Title="Transport Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <label class="col-md-4 control-label text-right">
                                                <span class="required">*</span> Transport Name
                                            </label>
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtTransportName" placeholder="Transport Name"
                                                    TabIndex="1" runat="server" MaxLength="50" MsgObrigatorio="Transport Name"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        function VerificaCamposObrigatorios() {
            try {
                if (VerificaObrigatorio('#<%=txtTransportName.ClientID%>', '#Avisos') == false) {
