<%@ Page Title="SubCategory Master" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="SubCategoryMaster.aspx.cs" Inherits="Admin_Add_SubCategoryMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
                            ...
                            <div class="form-horizontal">
                                <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlCategory" CssClass="select2" runat="server" AutoPostBack="true"
                                                            TabIndex="1" Width="100%" MsgObrigatorio="Category">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <label class="col-md-4 control-label text-right">
                                                <span class="required">*</span> SubCategory Name
                                            </label>
                                            <div class="col-md-4">
                                                <asp:TextBox CssClass="form-control " ID="txtSubCategoryName" placeholder="Tally Name"
    ...
    <script type="text/javascript">
        function VerificaCamposObrigatorios() {
            try {
                if (VerificaValorCombo('#<%=ddlCategory.ClientID%>', '#Avisos') == false) {
                    $("#Avisos").fadeOut(6000);
                    return false;
                }
                if (VerificaObrigatorio('#<%=txtSubCategoryName.ClientID%>', '#Avisos') == false) {
                    $("#Avisos").fadeOut(6000);
                    return false;
                }
                else {
