<%@ Page Title="Account ledger master" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewAccountLedgerMaster.aspx.cs" Inherits="Account_VIEW_ViewAccountLedgerMaster" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Account ledger master
                            </div>
                            <div class="tools">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="dgState" runat="server" Width="100%" AutoGenerateColumns="False"
                                        CellPadding="4" ForeColor="#333333" GridLines="None" DataKeyNames="L_CODE" Font-Names="Verdana"
                                        ...
                                        <Columns>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <li>
                                                                    <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                        Text="View" CommandArgument='<%# Bind("L_CODE") %>'><i class="fa fa-search"></i> View</asp:LinkButton>
                                                                </li>
                                                                <li>
                                                                    <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                        Text="Modify" CommandArgument='<%# Bind("L_CODE") %>'><i class="fa fa-edit"></i> Modify</asp:LinkButton>
                                                                </li>
                                                                <li>
                                            ...
                                            <asp:TemplateField HeaderText="L_CODE" SortExpression="L_CODE" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblL_CODE" runat="server" Text='<%# Bind("L_CODE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ledger Name" SortExpression="L_NAME" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblL_NAME" runat="server" Text='<%# Eval("L_NAME") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Account Type" SortExpression="L_ACCTYPE" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblL_ACCTYPE" runat="server" Text='<%# Eval("L_ACCTYPE") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Opening Bal" SortExpression="L_OPBAL" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblL_OPBAL" runat="server" Text='<%# Eval("L_OPBAL") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                        </Columns>
