<%@ Page Title="Remark Master" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="ViewRemark.aspx.cs" Inherits="Account_Masters_VIEW_ViewRemark" %>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel100" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:GridView ID="dgProcessMaster" TabIndex="3" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        CssClass="table table-striped table-bordered table-advance table-hover"  DataKeyNames="R_CODE"
                                        ...
                                        <Columns>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <li>
                                                                    <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                        Text="" CommandArgument='<%# Bind("R_CODE") %>'><i class="fa fa-search"></i> View</asp:LinkButton>
                                                                </li>
                                                                <li>
                                                                    <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                        Text="" CommandArgument='<%# Bind("R_CODE") %>'><i class="fa fa-edit"></i> Modify</asp:LinkButton>
                                                                </li>
                                                                <li>
                                            ...
                                            <asp:TemplateField HeaderText="R_CODE" SortExpression="R_CODE" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblR_CODE" runat="server" Text='<%# Bind("R_CODE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Remark" SortExpression="R_DESC" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblR_DESC" CssClass="" runat="server" Text='<%# Eval("R_DESC") %>'></asp:Label>
                                                </ItemTemplate>
