<%@ Page Title="Reciept Entry" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="RecieptEntry.aspx.cs" Inherits="Account_Transactions_ADD_RecieptEntry"
                                                            ...
                                                            <asp:GridView ID="dgInwardMaster" TabIndex="15" runat="server" Width="100%" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="REF Code" SortExpression="RCPD_REF_CODE" HeaderStyle-HorizontalAlign="Left"
                                                                        Visible="False">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblRCPD_REF_CODE" CssClass="" runat="server" Visible="false" Text='<%# Eval("RCPD_REF_CODE") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="RCPD_INVOICE_CODE" Visible="false" SortExpression="RCPD_INVOICE_CODE"
                                                                        HeaderStyle-HorizontalAlign="Left">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblRCPD_INVOICE_CODE" CssClass="" runat="server" Text='<%# Eval("RCPD_INVOICE_CODE") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Left" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="RCPD_INVOICE_CODE_TEMP" Visible="false" SortExpression="RCPD_INVOICE_CODE_TEMP"
                                                                        HeaderStyle-HorizontalAlign="Left">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblRCPD_INVOICE_CODE_TEMP" CssClass="" runat="server" Text='<%# Eval("RCPD_INVOICE_CODE_TEMP") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Left" />
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Amount" SortExpression="RCPD_AMOUNT" HeaderStyle-HorizontalAlign="Left">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblRCPD_AMOUNT" CssClass="" runat="server" Text='<%# Eval("RCPD_AMOUNT") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Left" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Adjs. Amt" SortExpression="RCPD_ADJ_AMOUNT" HeaderStyle-HorizontalAlign="Right">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblRCPD_ADJ_AMOUNT" CssClass="" runat="server" Text='<%# Eval("RCPD_ADJ_AMOUNT") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Right" CssClass="text-right" />
                                                                        <ItemStyle HorizontalAlign="Right" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Remark" SortExpression="RCPD_REMARK" HeaderStyle-HorizontalAlign="Right">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblRCPD_REMARK" CssClass="" runat="server" Text='<%# Eval("RCPD_REMARK") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Right" CssClass="text-right" />
                                                                        <ItemStyle HorizontalAlign="Right" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Type" SortExpression="RCPD_TYPE" HeaderStyle-HorizontalAlign="Right">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblRCPD_TYPE" CssClass="" runat="server" Text='<%# Eval("RCPD_TYPE") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Right" CssClass="text-right" />
                                                                        <ItemStyle HorizontalAlign="Right" />
                                                                    </asp:TemplateField>
