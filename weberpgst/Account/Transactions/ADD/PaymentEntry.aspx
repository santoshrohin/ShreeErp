<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="PaymentEntry.aspx.cs"
    Inherits="Account_Transactions_ADD_PaymentEntry" Title="Payment Entry" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Payment Entry
                            </div>
                            <div class="tools">
                                <a href="javascript:;" class="collapse"></a>
                                <asp:LinkButton ID="LinkButton1" CssClass="remove" TabIndex="19" runat="server" OnClick="btnCancel_Click"></asp:LinkButton>
                            </div>
                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="col-md-3 control-label text-right">
                                                    <font color="red">*</font> Customer/Supplier Name</label>
                                                <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" ID="txtPAYMno" placeholder="0"
                                                                TabIndex="2" runat="server" ReadOnly="true"></asp:TextBox>
                                                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" TargetControlID="txtPAYMno"
                                                                FilterType="Numbers" runat="server" />
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
                                                <label class="col-md-2 control-label text-right">
                                                    <font color="red">*</font> PAYM Date.</label>
                                                <div class="col-md-3">
                                                    <div class="input-group">
                                                        <asp:TextBox ID="txtPAYMDate" runat="server" CssClass="form-control input-sm" placeholder=""
                                                            TabIndex="3" msgObrigatorio="Please Select PAYM Date"></asp:TextBox>
                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                        <cc1:CalendarExtender ID="txtPAYMDate_CalendarExtender" runat="server" Enabled="True"
                                                            Format="dd MMM yyyy" TargetControlID="txtPAYMDate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <asp:UpdatePanel ID="UpdatePanel32" runat="server">
                                                        <ContentTemplate>
                                                            <asp:DropDownList ID="ddlLedger" TabIndex="6" MsgObrigatorio="Ledger" AutoPostBack="true"
                                                                Width="100%" CssClass="select2" runat="server">
                                                            </asp:DropDownList>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                ...
                                                <div class="col-md-3">
                                                    <asp:UpdatePanel ID="UpdatePanel35" runat="server">
                                                        <ContentTemplate>
                                                            <asp:TextBox CssClass="form-control text-right input-sm" TabIndex="7" ID="txtAmount"
                                                                placeholder="0.00" runat="server" onkeypress="return validateFloatKeyPress(this,event);"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <label class=" control-label label-sm">
                                                        <font color="red">* </font>Payment Amt
                                                    </label>
                                                        ...
                                                        <ContentTemplate>
                                                            <asp:GridView ID="dgInwardMaster" TabIndex="15" runat="server" Width="100%" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="REF Code" SortExpression="PAYMD_REF_CODE" HeaderStyle-HorizontalAlign="Left"
                                                                        Visible="False">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblPAYMD_REF_CODE" CssClass="" runat="server" Visible="false" Text='<%# Eval("PAYMD_REF_CODE") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Left" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Refer Type" Visible="true" SortExpression="REF_DESC"
                                                                        HeaderStyle-HorizontalAlign="Left">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblREF_DESC" CssClass="" runat="server" Text='<%# Eval("REF_DESC") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Left" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="PAYMD_INVOICE_CODE" Visible="false" SortExpression="PAYMD_INVOICE_CODE"
                                                                        HeaderStyle-HorizontalAlign="Left">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblPAYMD_INVOICE_CODE" CssClass="" runat="server" Text='<%# Eval("PAYMD_INVOICE_CODE") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Left" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="PAYMD_INVOICE_CODE_TEMP" Visible="false" SortExpression="PAYMD_INVOICE_CODE_TEMP"
                                                                        HeaderStyle-HorizontalAlign="Left">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblPAYMD_INVOICE_CODE_TEMP" CssClass="" runat="server" Text='<%# Eval("PAYMD_INVOICE_CODE_TEMP") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Left" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Invoice No" SortExpression="INVOICE_NO" HeaderStyle-HorizontalAlign="Left"
                                                                        Visible="true">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblINVOICE_NO" CssClass="" runat="server" Visible="true" Text='<%# Eval("INVOICE_NO") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Left" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Amount" SortExpression="PAYMD_AMOUNT" HeaderStyle-HorizontalAlign="Left">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblPAYMD_AMOUNT" CssClass="" runat="server" Text='<%# Eval("PAYMD_AMOUNT") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Left" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Adjs. Amt" SortExpression="PAYMD_ADJ_AMOUNT" HeaderStyle-HorizontalAlign="Right">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblPAYMD_ADJ_AMOUNT" CssClass="" runat="server" Text='<%# Eval("PAYMD_ADJ_AMOUNT") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Right" CssClass="text-right" />
                                                                        <ItemStyle HorizontalAlign="Right" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Remark" SortExpression="PAYMD_REMARK" HeaderStyle-HorizontalAlign="Right">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblPAYMD_REMARK" CssClass="" runat="server" Text='<%# Eval("PAYMD_REMARK") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Right" CssClass="text-right" />
                                                                        <ItemStyle HorizontalAlign="Right" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Type" SortExpression="PAYMD_TYPE" HeaderStyle-HorizontalAlign="Right">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblPAYMD_TYPE" CssClass="" runat="server" Text='<%# Eval("PAYMD_TYPE") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Right" CssClass="text-right" />
                                                                        <ItemStyle HorizontalAlign="Right" />
                                                                    </asp:TemplateField>
    ...
    <script type="text/javascript">
        function VerificaCamposObrigatorios() {
            try {
                ...
                else if (VerificaObrigatorio('#<%=txtPAYMDate.ClientID%>', '#Avisos') == false) {
                    $("#Avisos").fadeOut(6000);
                    return false;
                }
