<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewPaymentEntry.aspx.cs" Inherits="Account_Transactions_VIEW_ViewPaymentEntry" Title="Payment Entry" %>
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                            <ContentTemplate>
                                                <asp:GridView ID="dgDetailPO" TabIndex="3" runat="server" AutoGenerateColumns="False" Width="100%"
                                                    CellPadding="4" Font-Size="12px" Font-Names="Verdana" GridLines="Both" DataKeyNames="PAYM_CODE"
                                                    ...
                                                    <Columns>
                                                                        ...
                                                                        <ul class="dropdown-menu" role="menu">
                                                                            <li>
                                                                                <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                                    Text="View" CommandArgument='<%# Bind("PAYM_CODE") %>'><i class="fa fa-search"></i> View</asp:LinkButton>
                                                                            </li>
                                                                            <li>
                                                                                <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                                    Text="Modify" CommandArgument='<%# Bind("PAYM_CODE") %>'><i class="fa fa-edit"></i> Modify</asp:LinkButton>
                                                                            </li>
                                                                            <li>
                                                                                <asp:LinkButton ID="lnkPrint" runat="server" CausesValidation="False" CommandName="Print"
                                                                                    Text="Print" CommandArgument='<%# Bind("PAYM_CODE") %>'><i class="fa fa-print"></i> Print</asp:LinkButton>
                                                                            </li>
                                                                            <li>
                                                                                <asp:LinkButton ID="lnkChequePrint" runat="server" CausesValidation="False" CommandName="Cheque Print"
                                                                             Text="Cheque Peint" CommandArgument='<%# Bind("PAYM_CODE") %>'><i class="fa fa-print"></i> Cheque Print</asp:LinkButton>
                                                                            </li>
                                                                            <li>
                                                        ...
                                                        <asp:TemplateField HeaderText="CPOM_CODE" SortExpression="CPOM_CODE" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPAYM_CODE" CssClass="formlabel" runat="server" Text='<%# Bind("PAYM_CODE") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Payment Number" SortExpression="PAYM_NO" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPAYM_NO" runat="server" Text='<%# Eval("PAYM_NO") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Payment Date" SortExpression="PAYM_DATE" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPAYM_DATE" runat="server" Text='<%# Eval("PAYM_DATE") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Inward Code" SortExpression="PAYM_P_CODE" HeaderStyle-HorizontalAlign="Left"
                                                            Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPAYM_P_CODE" runat="server" Text='<%# Eval("PAYM_P_CODE") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Cheque No." SortExpression="PAYM_CHEQUE_NO" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPAYM_CHEQUE_NO" CssClass=" Control-label" runat="server" Text='<%# Eval("PAYM_CHEQUE_NO") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="AMOUNT" SortExpression="PAYM_AMOUNT" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPAYM_AMOUNT" CssClass=" Control-label" runat="server" Text='<%# Eval("PAYM_AMOUNT") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:TemplateField>
                                                    </Columns>
