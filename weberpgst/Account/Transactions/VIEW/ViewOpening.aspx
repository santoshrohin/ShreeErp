<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewOpening.aspx.cs"
    Inherits="Account_Transactions_VIEW_ViewOpening" Title="Opening Bal View" %>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="btn-group pull-right">
                                                <asp:LinkButton ID="btnAddNew" Visible="false" CssClass="btn green" runat="server" TabIndex="2" OnClick="btnAddNew_Click">Add New  <i class="fa fa-plus"></i></asp:LinkButton>
                                            </div>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel100" runat="server">
                                        <ContentTemplate>
                                            <asp:GridView ID="dgDetailPO" runat="server" AutoGenerateColumns="False" Width="100%"
                                                CellPadding="4" Font-Size="12px" Font-Names="Verdana" GridLines="Both" DataKeyNames="ACCNT_OPE_CODE"
                                                ...
                                                <Columns>
                                                                    ...
                                                                    <ul class="dropdown-menu" role="menu">
                                                                        <li>
                                                                            <asp:LinkButton ID="lnkView" runat="server" CausesValidation="False" CommandName="View"
                                                                                Text="View" CommandArgument='<%# Bind("ACCNT_OPE_CODE") %>'><i class="fa fa-search"></i> View</asp:LinkButton>
                                                                        </li>
                                                                        <li>
                                                                            <asp:LinkButton ID="lnkModify" runat="server" CausesValidation="False" CommandName="Modify"
                                                                                Text="Modify" CommandArgument='<%# Bind("ACCNT_OPE_CODE") %>'><i class="fa fa-edit"></i> Modify</asp:LinkButton>
                                                                        </li>
                                                                        <li>
                                                                            <asp:LinkButton ID="lnkPrint" runat="server" CausesValidation="False" CommandName="Print"
                                                                                Text="Print" CommandArgument='<%# Bind("ACCNT_OPE_CODE") %>'><i class="fa fa-print"></i> Print</asp:LinkButton>
                                                                        </li>
                                                                        <li>
                                                                            <asp:LinkButton ID="lnkPrintMult" runat="server" CausesValidation="False" CommandName="PrintMult"
                                                                                Visible="false" Text="Print" CommandArgument='<%# Bind("ACCNT_OPE_CODE") %>'><i class="fa fa-print"></i> </asp:LinkButton>
                                                                        </li>
                                                                        <li>
                                                    ...
                                                    <asp:TemplateField HeaderText="CPOM_CODE" SortExpression="CPOM_CODE" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblRCP_CODE" CssClass="formlabel" runat="server" Text='<%# Bind("ACCNT_OPE_CODE") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="AMOUNT" SortExpression="AMOUNT" HeaderStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblAMT" CssClass=" Control-label" runat="server" Text='<%# Eval("AMT") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                    </asp:TemplateField>
                                                </Columns>
