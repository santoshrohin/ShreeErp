...
public partial class RoportForms_VIEW_ViewReceiptRegister : System.Web.UI.Page
{
    #region Page_Load
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (chkAllParty.Checked != true && chkDateAll.Checked != true)
                StrCondition = StrCondition + "P.P_CODE='" + ddlPartyName.SelectedValue + "' and RCP_DATE between '" + Convert.ToDateTime(From).ToString("dd/MMM/yyyy") + "' AND '" + Convert.ToDateTime(To).ToString("dd/MMM/yyyy") + "' AND ";
            else if (chkDateAll.Checked == false && chkAllParty.Checked == true)
                StrCondition = StrCondition + "RCP_DATE between '" + Convert.ToDateTime(From).ToString("dd/MMM/yyyy") + "' AND '" + Convert.ToDateTime(To).ToString("dd/MMM/yyyy") + "' AND ";
            else if (chkDateAll.Checked == true && chkAllParty.Checked == false)
                StrCondition = StrCondition + "P.P_CODE='" + ddlPartyName.SelectedValue + "' and RCP_DATE between '" + Convert.ToDateTime(From).ToString("dd/MMM/yyyy") + "' AND '" + Convert.ToDateTime(To).ToString("dd/MMM/yyyy") + "' AND ";
            Response.Redirect("~/Account/ReportForms/ADD/ReceiptRegister.aspx?Title=" + Title + "&ALL_DATE=" + chkDateAll.Checked.ToString() + "&All_CUST=" + chkAllParty.Checked.ToString() + "&FromDate=" + Convert.ToDateTime(From.ToString()).ToString("dd/MMM/yyyy") + "&ToDate=" + Convert.ToDateTime(To.ToString()).ToString("dd/MMM/yyyy") + "&p_name=" + ddlPartyName.SelectedValue.ToString() + "&StrCondition=" + StrCondition + "", false);
