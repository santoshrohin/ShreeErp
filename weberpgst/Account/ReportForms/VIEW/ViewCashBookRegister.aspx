<%@ Page Title="Cash Book Entry Register" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="ViewCashBookRegister.aspx.cs" Inherits="Account_VIEW_ViewCashBookRegister" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Cash Book Entry Register
                            </div>
                            <div class="tools">
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel6">
                                                    <ContentTemplate>
                                                        <asp:RadioButtonList ID="rbtGroup" runat="server" AutoPostBack="True" TabIndex="1"
                                                            ...
                                                            <asp:ListItem Value="1">&nbsp&nbsp&nbsp&nbsp  Bank/Cash Name</asp:ListItem>
                                                        </asp:RadioButtonList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                                    ...
                                                    <ContentTemplate>
                                                        <div class="input-group">
                                                            <asp:TextBox ID="txtFromDate" runat="server" placeholder="dd MMM yyyy" CssClass="form-control"
                                                                MsgObrigatorio="Please Select From Date" TabIndex="6" ValidationGroup="Save"
                                                    ...
                                                    <ContentTemplate>
                                                        <div class="input-group">
                                                            <asp:TextBox ID="txtToDate" runat="server" placeholder="dd MMM yyyy" CssClass="form-control"
                                                                MsgObrigatorio="Please Select To Date" TabIndex="7" ValidationGroup="Save" OnTextChanged="txtToDate_TextChanged"></asp:TextBox>
                                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlCustomerName" runat="server" AutoPostBack="True" CssClass="select2"
                                                            MsgObrigatorio="Please Select Bank/Cash Name" Width="100%" TabIndex="11">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
