...
public partial class RoportForms_ADD_RecieptReport : System.Web.UI.Page
{
    ...
    private void GenerateReport(string Title, int P_Code)
    {
        try
        {
            ...
            rptname.Load(Server.MapPath("~/Account/Reports/RecieptReport.rpt"));
            rptname.FileName = Server.MapPath("~/Account/Reports/RecieptReport.rpt");
