                                        ...
                                        <div class="form-group">
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel5">
                                                    <ContentTemplate>
                                                        <div class="input-group">
                                                            <asp:TextBox ID="txtFromDate" AutoPostBack="true" runat="server" placeholder="dd MMM yyyy"
                                            ...
                                            <div class="col-md-2">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel4">
                                                    <ContentTemplate>
                                                        <div class="input-group">
                                                            <asp:TextBox ID="txtToDate" runat="server" AutoPostBack="true" placeholder="dd MMM yyyy"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <asp:LinkButton ID="btnImport" runat="server" CssClass="btn dark" ValidationGroup="Load"
                                                    TabIndex="4" OnClick="btnImport_Click"><i class="fa fa-upload">&nbsp;Import Excel</i></asp:LinkButton>
                                            </div>
                                            <div class="col-md-2">
                                            </div>
                                        </div>
