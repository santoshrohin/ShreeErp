<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewWorkOrderRegister.aspx.cs" Inherits="RoportForms_VIEW_ViewWorkOrderRegister" Title="Work Order Register" %>
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel4">
                                                <ContentTemplate>
                                                    ...
                                                    <%--<cc1:CalendarExtender ID="CalendarExtender1" BehaviorID="calendar2" runat="server"
                                                        Enabled="True" TargetControlID="txtToDate" PopupButtonID="txtToDate" OnClientShown="onCalendarShown"
                                                        Format="MMM/yyyy">
                                                    </cc1:CalendarExtender>--%>
