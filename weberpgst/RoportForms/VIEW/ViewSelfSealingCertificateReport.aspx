<%@ Page Title="Self Sealing Certificate Report" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewSelfSealingCertificateReport.aspx.cs" Inherits="RoportForms_VIEW_ViewSelfSealingCertificateReport" %>
                                           ...
                                           <font color="red">*</font>From Invoice
                                            ...
                                            <div class="col-md-3">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel5">
                                                    <ContentTemplate>                                                     
                                                        <asp:DropDownList ID="ddlFromInvoiceNo" runat="server" MsgObrigatorio="From Invoice No"  CssClass="select2_category form-control"
                                                            TabIndex="11" AutoPostBack="true"  OnSelectedIndexChanged="ddlFromInvoiceNo_SelectedIndexChanged">
                                                        </asp:DropDownList>                                                         
                                            ...
                                            <div class="col-md-3">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel4">
                                                    <ContentTemplate>
                                                       ...
                                                       <asp:DropDownList ID="ddlToInvoiceNo" runat="server" MsgObrigatorio="To Invoice No"  CssClass="select2_category form-control"
                                                            TabIndex="11" AutoPostBack="true" OnSelectedIndexChanged="ddlToInvoiceNo_SelectedIndexChanged">
                                                        </asp:DropDownList>
