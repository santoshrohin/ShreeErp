                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel7">
                                                    <ContentTemplate>
                                                        <asp:RadioButtonList ID="rbtType" runat="server" AutoPostBack="True" TabIndex="1"
                                                            ...
                                                            <asp:ListItem Value="1">&nbsp;ModuleWise</asp:ListItem>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel11">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlModule" runat="server" AutoPostBack="True" CssClass="select2_category form-control"
                                                            MsgObrigatorio="Please Select Module" TabIndex="9">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlUser" runat="server" AutoPostBack="True" CssClass="select2_category form-control"
                                                            MsgObrigatorio="Please Select User" TabIndex="11">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
