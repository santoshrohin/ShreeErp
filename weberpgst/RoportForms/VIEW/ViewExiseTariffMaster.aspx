<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewExiseTariffMaster.aspx.cs" Inherits="RoportForms_VIEW_ViewExiseTariffMaster" %>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel4">
                                                    <ContentTemplate>
                                                        <asp:CheckBox ID="ChkExiseTariffNoAll" runat="server" CssClass="checker" 
                                                            Text="All" AutoPostBack="True"
                                                            TabIndex="3" oncheckedchanged="ChkExiseTariffNoAll_CheckedChanged" />
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlSubComponent" runat="server" placeholder="Select Finished Component"
                                                            AutoPostBack="True" CssClass="select2_category form-control" TabIndex="2" OnSelectedIndexChanged="ddlSubComponent_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                    <Triggers>
