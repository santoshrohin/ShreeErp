<%@ Page Title="Delivery Challan Register" Language="C#" MasterPageFile="~/main.master"
    AutoEventWireup="true" CodeFile="DeliveryChallanRegister.aspx.cs" Inherits="RoportForms_VIEW_DeliveryChallanRegister" %>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel11">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlFinishedComponent" runat="server" Width="100%" AutoPostBack="True"
