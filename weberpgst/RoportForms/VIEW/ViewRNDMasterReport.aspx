<%@ Page Title="Master Report" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewRNDMasterReport.aspx.cs" Inherits="RoportForms_VIEW_ViewRNDMasterReport" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                            ...
                            <%--<div class="form-actions fluid">
                                    <div class="col-md-offset-4 col-md-9">
                                        <asp:LinkButton ID="btnShow" CssClass="btn green" TabIndex="2" runat="server" OnClientClick="return VerificaCamposObrigatorios();"
                                            OnClick="btnShow_Click"><i class="fa fa-check-square"> </i>  Show </asp:LinkButton>
                                        <asp:LinkButton ID="btnCancel" CssClass="btn default" OnClientClick="return confirm('Are you sure want to cancel this Request?')" OnClick="btnCancel_Click" TabIndex="3" runat="server" 
