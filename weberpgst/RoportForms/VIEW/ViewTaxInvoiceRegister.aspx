                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel213">
                                                    <ContentTemplate>
                                    ...
                                    <div class="col-md-offset-4 col-md-9">
                                        ...
                                        <asp:LinkButton ID="btnExport" CssClass="btn green" TabIndex="15" runat="server"
                                            OnClientClick="return VerificaCamposObrigatorios();" OnClick="btnExport_Click"><i class="fa fa-check-square"> </i>  Export </asp:LinkButton>
                                             ...
                                             <asp:LinkButton ID="Supplementary" CssClass="btn green" TabIndex="15" runat="server"
                                            OnClientClick="return VerificaCamposObrigatorios();" OnClick="btnExport_Click1"><i class="fa fa-check-square"> </i>  Supplementary </asp:LinkButton>
                                            
                                            
                                             <asp:LinkButton ID="LinkButton1" CssClass="btn green" TabIndex="15" runat="server"
                                            OnClientClick="return VerificaCamposObrigatorios();" OnClick="btnExport_Click2"><i class="fa fa-check-square"> </i>  Export For Gst </asp:LinkButton>
                                    </div>
                                </div>
                            </div>
                        </div>
