...
public partial class RoportForms_VIEW_ViewBatchRegister : System.Web.UI.Page
{
    #region Variable
    static string right = "";
    string From = "";
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            To = txtToDate.Text;
            Response.Redirect("~/RoportForms/ADD/BatchRegister.aspx?Title=" + Title + "&Date_All=" + chkDateAll.Checked.ToString() + "&From=" + From + "&To=" + To + "&Type=0", false);


        }
        catch (Exception Ex)
        {
            CommonClasses.SendError("Batch Register", "btnShow_Click", Ex.Message);
        }
    }
    #endregion
}
