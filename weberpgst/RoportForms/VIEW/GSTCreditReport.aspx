<%@ Page Title="GST Credit Report" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true"
    CodeFile="GSTCreditReport.aspx.cs" Inherits="RoportForms_VIEW_GSTCreditReport" %>
                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Pending GIN For GST Credit Entries
                            </div>
                            <div class="tools">
                                            ...
                                            <div class="col-md-12">
                                                        ...
                                                        <ContentTemplate>
                                                            <div class="input-group">
                                                                <asp:TextBox ID="txtFromDate" runat="server" placeholder="dd MMM yyyy" AutoPostBack="true"
                                                                    CssClass="form-control" TabIndex="6" ValidationGroup="Save"></asp:TextBox>
                                                ...
                                                <div class="col-md-3">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel4">
                                                        <ContentTemplate>
                                                            <div class="input-group">
                                                                <asp:TextBox ID="txtToDate" runat="server" placeholder="dd MMM yyyy" AutoPostBack="true"
                                                                    CssClass="form-control" TabIndex="7" ValidationGroup="Save"></asp:TextBox>
                                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
