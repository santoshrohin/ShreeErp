<%@ Page Title="Stock Ledger Register" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ViewStockLedgerTypewise.aspx.cs" Inherits="RoportForms_VIEW_ViewStockLedgerTypewise" %>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel6">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlitemtype" runat="server" placeholder="select Type"
