<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="CreditNotePrint.aspx.cs"
    ClientTarget="uplevel" Inherits="RoportForms_ADD_CreditNotePrint" Title="Credit Note Print" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Credit Note Print
                            </div>
                            <div class="tools">
