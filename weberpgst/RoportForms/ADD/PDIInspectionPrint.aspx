<%@ Page Title="PDI Report" Language="C#" MasterPageFile="~/main.master" ClientTarget="uplevel" AutoEventWireup="true"
    CodeFile="PDIInspectionPrint.aspx.cs" Inherits="RoportForms_ADD_PDIInspectionPrint" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>PDI Report
                            </div>
                            <div class="tools">
