<%@ Page Title="Debit Print" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="DebitPrint.aspx.cs"ClientTarget="uplevel" Inherits="RoportForms_ADD_DebitPrint" %>
                ...
                <div class="col-md-10">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Debit Print
                            </div>
                            <div class="tools">
