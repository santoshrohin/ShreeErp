<%@ Page Title="Purchase Order" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" 
    CodeFile="SupplierOrderPrint.aspx.cs" ClientTarget="uplevel" Inherits="RoportForms_ADD_SupplierOrderPrint" %>
                                    ...
                                    <div class="row">
                                        <center>
                                            <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="True"
                                                Height="50px" ReuseParameterValuesOnRefresh="True" DisplayGroupTree="False"  DisplayToolbar="True" EnableDatabaseLogonPrompt="False" />
                                        </center>
                                    </div>
                                </div>
                            </div>
